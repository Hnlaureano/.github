...
<!--
  💡 DICA: coloque a logo oficial do hospital em profile/assets/logo.png
  e descomente a linha abaixo para exibi-la em destaque no topo.

<p align="center">
  <img src="assets/logo.png" alt="Hospital Napoleão Laureano" width="220"/>
</p>
-->

<p align="center">
  <a href="https://hlaureano.org.br">
    <img src="https://img.shields.io/badge/🌐_Site_Oficial-hlaureano.org.br-1a7a8c?style=for-the-badge"/>
  </a>
  <img src="https://img.shields.io/badge/📍_João_Pessoa_—_PB-Brasil-0d3b66?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/🎗️_Refer%C3%AAncia_em_Oncologia-e63946?style=for-the-badge"/>
</p>
...
O **Hospital Napoleão Laureano** é uma instituição **filantrópica** e uma **referência no tratamento oncológico** na Paraíba. Há décadas, dedicamos nossa missão a **acolher, tratar e cuidar** de milhares de pacientes, unindo **humanização, ciência e tecnologia** para oferecer o melhor cuidado a quem mais precisa.

Este é o nosso espaço no GitHub, onde reunimos os **projetos, sistemas e iniciativas de tecnologia** que apoiam e modernizam a assistência à saúde dentro da instituição.

> _“A vida é o nosso maior compromisso.”_
...
Desenvolvemos e mantemos internamente um ecossistema de sistemas que sustenta a operação do hospital no dia a dia:
...
<p align="center">
  <sub>Todos containerizados, com deploy padronizado via Docker + Nginx + Gunicorn e integração ao Active Directory.</sub>
</p>
...
Investimos em tecnologia para tornar o cuidado mais **eficiente, seguro e acessível**. Nossos sistemas são construídos com um stack robusto e moderno:
...
<p>
  ...
  <img src="https://img.shields.io/badge/PgBouncer-2a9d8f?style=for-the-badge"/>
</p>
...
<p>
  <img src="https://img.shields.io/badge/Active_Directory_(LDAP)-0078D4?style=for-the-badge&logo=microsoft&logoColor=white"/>
...
Faz parte da equipe de tecnologia do hospital? Seja bem-vindo(a)! 💙

- 🔍 Explore os repositórios da organização
- 🐛 Abra _issues_ para relatar problemas ou sugerir melhorias
- 🌿 Trabalhe sempre em _branches_ e abra _Pull Requests_ para revisão
- 📝 Siga os padrões de commit e documentação de cada projeto
...
<p align="center">
  📍 <strong>João Pessoa — Paraíba, Brasil</strong>
</p>
...
<p align="center">
  <sub>💙 Feito com dedicação pela equipe de Tecnologia da Informação do Hospital Napoleão Laureano</sub>
</p>
